...
-- Default curves and animations, see https://https://https://wiki.hypr.land/Configuring/Advanced-and-Cool/Animations/
...
--hl.animation({ leaf = "global", enabled = false, bezier = "default" })
...
hl.config({
	...
	misc = {
		disable_hyprland_logo = true, -- remove wallpaper
		disable_splash_rendering = true, -- remove wallpaper messaged
